...
async function main() {
  ...
  // Market 1: ETH/USD >= $5,000
  console.log('=== Market 1: ETH/USD >= $5,000 ===');
  ...
  ritualPredict.bet(market1.id, 'YES', BigInt(150));
  ritualPredict.bet(market1.id, 'NO', BigInt(100));

  // Market 2: BTC/USD >= $100,000
  console.log('\n=== Market 2: BTC/USD >= $100,000 ===');
  ...
  ritualPredict.bet(market2.id, 'NO', BigInt(250));

  // Market 3: SOL/USD < $200
  console.log('\n=== Market 3: SOL/USD < $200 ===');
  ...
  ritualPredict.bet(market3.id, 'YES', BigInt(50));
  ritualPredict.bet(market3.id, 'NO', BigInt(30));
